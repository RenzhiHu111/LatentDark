...
parser.add_argument("-opt", type=str, default='./codes/config/unet-latent/options/test/test_latent.yml', help="Path to options YMAL file.")
...
for test_loader in test_loaders:
    ...
    for i, test_data in enumerate(test_loader):
        ...
        #### input dataset_LQ
        LQ, GT, R = test_data["LQ"], test_data["GT"], test_data["R"]

        model.feed_data(LQ, R, GT)
        tic = time.time()
        model.test()
        toc = time.time()
